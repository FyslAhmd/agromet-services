      ...
      <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gray-50 px-4 sm:px-5 md:px-6 py-3 sm:py-4 rounded-b-xl sm:rounded-b-2xl border-t flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-2.5 bg-linear-to-r from-[#0a3d3d] to-[#0d5555] text-white rounded-lg hover:from-[#083535] hover:to-[#0a3d3d] transition-all shadow-lg font-medium flex items-center justify-center gap-2 text-sm sm:text-base order-1 sm:order-2"
          >
