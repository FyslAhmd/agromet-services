...
const DistrictWiseModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="sticky top-0 bg-linear-to-r from-[#0a3d3d] to-[#0d5555] text-white px-4 sm:px-5 md:px-6 py-4 sm:py-5 rounded-t-xl sm:rounded-t-2xl flex justify-between items-start gap-3 z-10">
          ...
          <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3 sm:mb-4">
              <h4 className="text-base sm:text-lg font-bold text-gray-800 flex items-center gap-2">
                <span className="bg-teal-100 text-teal-700 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="text-xs sm:text-sm px-2 sm:px-3 py-1.5 bg-teal-50 text-teal-600 rounded-lg hover:bg-teal-100 transition-colors font-medium"
                >
                  Select All
                </button>
                <button
              ...
              {bangladeshDistricts.map((district) => (
                ...
                >
                  <input
                    ...
                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-teal-600 rounded focus:ring-2 focus:ring-teal-500 shrink-0"
                  />
              ...
              {riceSeasons.map((season) => (
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600 focus:ring-2 focus:ring-teal-500 shrink-0"
                  />
                  <div className="flex-1 min-w-0">
