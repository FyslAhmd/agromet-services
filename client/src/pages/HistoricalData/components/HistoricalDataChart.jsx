      ...
      <div className="card-body p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-linear-to-br from-primary to-primary-focus rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="bg-linear-to-r from-gray-50 to-white rounded-xl p-4 mb-4 border border-gray-100">
