        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 md:py-20">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-medium text-teal-100">Bangladesh Rice Research Institute</span>
            </div>
            ...
            <p className="text-sm sm:text-base md:text-lg text-teal-100/90 leading-relaxed max-w-2xl mx-auto px-2">
              A comprehensive digital platform empowering farmers, researchers, and agricultural
              stakeholders with real-time weather data, climate analytics, and rice-related statistics.
            </p>
          </div>
        </div>
        {/* Wave divider */}
        <div className="h-6 sm:h-8 md:h-12 bg-gray-50/50" style={{ clipPath: "ellipse(55% 100% at 50% 100%)" }} />
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-5 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">About the Portal</h2>
            </div>
            ...
            <div className="space-y-4 sm:space-y-5 text-sm sm:text-base text-gray-600 leading-relaxed">
              <p className="text-justify">
                ...
                providing accessible, accurate, and timely agrometeorological information.
              </p>
              <p className="text-justify">
                ...
                temperature, rainfall, humidity, solar radiation, wind speed, and soil conditions.
              </p>
              <p className="text-justify">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="px-5 sm:px-6 md:px-8 lg:px-10 pt-5 sm:pt-6 md:pt-8 lg:pt-10 pb-2 sm:pb-3">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-5 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Key Features</h2>
            </div>
          </div>
        ...
        <div className="bg-linear-to-br from-[#0a3d3d] to-[#0d5555] rounded-2xl shadow-sm overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-4 sm:mb-5">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Our Mission</h2>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-6 sm:mb-8">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Patrons</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-2xl mx-auto">
              {patrons.map((patron, index) => (
                <div key={index} className="text-center group">
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">{patron.designation}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-6 sm:mb-8">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Plan, Database & Execution By</h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6 md:gap-8 max-w-2xl mx-auto p-4 sm:p-5 md:p-6 rounded-xl bg-gray-50/80 border border-gray-100">
              ...
              <div className="text-center sm:text-left space-y-2 sm:space-y-3 flex-1 min-w-0">
                <h4 className="text-lg sm:text-xl font-bold text-gray-900">Niaz Md. Farhat Rahman</h4>
                ...
                <div className="pt-2 sm:pt-3 space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-center sm:justify-start gap-2 text-xs sm:text-sm">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0d4a4a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:niaz.sust@gmail.com" className="text-[#0d4a4a] hover:underline truncate">niaz.sust@gmail.com</a>
                  </div>
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-2 text-xs sm:text-sm text-gray-600">
                    ...
                    <span className="text-xs">PABX 880-2-49272005-14 Ext. 395</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-6 sm:mb-8">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Development Team</h2>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 md:gap-8 max-w-3xl mx-auto">
              {/* Fullstack Developer */}
              <div className="text-center group p-4 sm:p-5 rounded-xl bg-gray-50/80 border border-gray-100 hover:border-teal-200 transition-all duration-200">
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-1 mb-3">Fullstack Developer</p>
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-center gap-2 text-xs sm:text-sm">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0d4a4a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:mollikmdriyadh@gmail.com" className="text-[#0d4a4a] hover:underline truncate">mollikmdriyadh@gmail.com</a>
                  </div>
              ...
              <div className="text-center group p-4 sm:p-5 rounded-xl bg-gray-50/80 border border-gray-100 hover:border-teal-200 transition-all duration-200">
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-1 mb-3">Frontend Developer & Designer</p>
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex items-center justify-center gap-2 text-xs sm:text-sm">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0d4a4a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:info.faysal.32@gmail.com" className="text-[#0d4a4a] hover:underline truncate">info.faysal.32@gmail.com</a>
                  </div>
                  <div className="flex items-center justify-center gap-2 text-xs sm:text-sm text-gray-600">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0d4a4a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 sm:p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-5 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Contact Information</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-xl bg-gray-50/80 border border-gray-100">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-[#0d4a4a]/10 flex items-center justify-center shrink-0 mt-0.5">
                  <svg className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-[#0d4a4a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Agromet Lab, Bangladesh Rice Research Institute (BRRI), Gazipur-1701, Bangladesh</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-xl bg-gray-50/80 border border-gray-100">
                ...
                <div className="min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-900">Email</p>
                  <a href="mailto:agromet@brri.gov.bd" className="text-xs sm:text-sm text-[#0d4a4a] hover:underline mt-0.5 block truncate">agromet@brri.gov.bd</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-xl bg-gray-50/80 border border-gray-100">
                ...
                <div className="min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-900">Call Center Helpline</p>
                  <p className="text-xs sm:text-sm text-gray-500 mt-0.5">09644300300</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 rounded-xl bg-gray-50/80 border border-gray-100">
                ...
                <div className="min-w-0">
                  <p className="text-xs sm:text-sm font-semibold text-gray-900">Website</p>
                  <a href="https://brri.gov.bd" target="_blank" rel="noopener noreferrer" className="text-xs sm:text-sm text-[#0d4a4a] hover:underline mt-0.5 block truncate">https://brri.gov.bd</a>
                </div>
              </div>
            </div>
          </div>
